      ...
      <div className="project-container row">
        ...
        <div className="row justify-content-center mb-4">
          <div className="col-sm-8 text-center">
            ...
            <p style={{ fontWeight: 'bold' , color: 'white', textAlign: 'justify', padding: '0px 20px', lineHeight: '1.6', fontSize: '1.4rem', marginBottom: '0px' }}>
            Embracing Black and White for Professional Portraits : </p> 
            <p style={{ color: 'white', textAlign: 'justify', padding: '0px 20px', lineHeight: '1.6', fontSize: '1.4rem', marginBottom: '0px' }}>
        ...
        <div className="row justify-content-center mb-4">
          <div className="col-sm-8 text-center">
            ...
            <p style={{ fontWeight: 'bold' , color: 'white', textAlign: 'justify', padding: '10px 20px', lineHeight: '1.6', fontSize: '1.4rem', marginBottom: '-10px' }}>
            A Play of Shadows and Light : </p>

 <p style={{ color: 'white', textAlign: 'justify', padding: '10px 20px', lineHeight: '1.6', fontSize: '1.4rem', marginBottom: '-10px' }}>
